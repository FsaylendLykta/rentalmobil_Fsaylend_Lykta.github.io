<?php
    ...
    $hasil = $koneksi->query("SELECT * FROM tbl_rental_Fsaylend_Lykta WHERE kode_booking = '$kode_booking'")->fetch();

    $id = $hasil['id_mobil'];
    $isi = $koneksi->query("SELECT * FROM tbl_mobil_Fsaylend_Lykta WHERE id_mobil = '$id'")->fetch();
